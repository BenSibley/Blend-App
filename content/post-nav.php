...
if( $previous_post ) {
	// text above the link
	$previous_text = __('Previous Post', 'blend-app');
	// if there is a title use it, else call it "The Previous Post"
	$previous_title = get_the_title( $previous_post ) ? get_the_title( $previous_post ) : __("The Previous Post", 'blend-app');
	// get the post link
...
// if there isn't a previous post
	...
	// text above the link
	$previous_text = __('No Older Posts', 'blend-app');
	// set the title to return to the blog
	$previous_title = __('Return to Blog', 'blend-app');
	// link to blog
...
if( $next_post ) {
	// text above the link
	$next_text = __('Next Post', 'blend-app');
	// if there is a title use it, else call it "The next Post"
	$next_title = get_the_title( $next_post ) ? get_the_title( $next_post ) : __("The Next Post", 'blend-app');
	// get the post link
...
// if there isn't a next post
	...
	// text above the link
	$next_text = __('No Newer Posts', 'blend-app');
	// set the title to return to the blog
	$next_title = __('Return to Blog', 'blend-app');
	// link to blog
	$next_link = home_url();
}
